...
const Actitudinal = require('./components/actitudinal/network');
const Procedimental = require('./components/procedimental/network');
const NotaActitudinal = require('./components/notaActitudinal/network');
const NotaProcedimental = require('./components/notaProcedimental/network');
...
app.use('/api/actitudinal', Actitudinal);
app.use('/api/procedimental', Procedimental);
app.use('/api/notaActitudinal', NotaActitudinal);
app.use('/api/notaProcedimental', NotaProcedimental);
